...

{
    home-manager.sharedModules = [ {
        services.flatpak = {
            packages = [
                {
                    appId = "${config.ethorbit.components.gaming.steam.flatpak.appNames.gamescope}";
                    origin = "flathub";
                }
                {
                    appId = "${config.ethorbit.components.gaming.steam.flatpak.appNames.mangohud}";
                    origin = "flathub";
                }
                {
                    appId = "${config.ethorbit.components.gaming.steam.flatpak.appNames.proton}";
