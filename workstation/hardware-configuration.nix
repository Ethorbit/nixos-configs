...

{
  ...
  age.secrets."homenas/samba/users/gaming/creds" = { file = ../homenas/secrets/samba/users/gaming/creds.age; };
  age.secrets."homenas/samba/users/videos/creds" = { file = ../homenas/secrets/samba/users/videos/creds.age; };
  age.secrets."homenas/samba/users/ai/creds" = { file = ../homenas/secrets/samba/users/ai/creds.age; };
  age.secrets."homenas/samba/users/hax/creds" = { file = ../homenas/secrets/samba/users/hax/creds.age; };
