...
in
{
    ...
    "workstation/nixos/containers/development/secrets/users/development/pass.age".publicKeys = [ ethorbit nixos ];
    "workstation/nixos/containers/media/secrets/users/media/pass.age".publicKeys = [ ethorbit nixos ];
