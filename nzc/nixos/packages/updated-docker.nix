# Slightly modified docker derivation from: https://github.com/NixOS/nixpkgs/blob/master/pkgs/applications/virtualization/docker/default.nix
{ lib, pkgs }:
...
rec {
  ...
  docker_20_10 = pkgs.callPackage dockerGen rec {
    version = "20.10.26";
    cliRev = "v${version}";
  ...
  docker_24 = pkgs.callPackage dockerGen rec {
    version = "24.0.5";
    cliRev = "v${version}";
  ...
  docker_24_0_0 = pkgs.callPackage dockerGen rec {
    version = "24.0.0";
    cliRev = "v${version}";
    cliHash = "sha256-twM1lfgf8MLZhuGmyUdG1KJ1RxiTxZ9DaDcJJdGJQZs=";
    mobyRev = "v${version}";
    mobyHash = "sha256-xa0Xq7YJgYeOpaNtaHiVqYg9JGRy/FeoMCvDKq2bYfo=";
    runcRev = "v1.1.8";
    runcHash = "sha256-rDJYEc64KW4Qa3Eg2oUjJqIKrg6THb5hxQFFbvb9Zp4=";
    containerdRev = "v1.7.1";
    containerdHash = "sha256-WwedtcsrDQwMQcKFO5nnPiHyGJpl5hXZlmpbBe1/ftY=";
